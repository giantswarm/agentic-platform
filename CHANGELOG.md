...
- Initial umbrella chart bundling `muster` 0.1.193 and `agentgateway` v1.2.1 (plus `agentgateway-crds` v1.2.1).
...
- `values.schema.json` covering umbrella-owned keys; subchart keys pass-through.
